...
'''
Creating a merged (and minified) JavaScript file sm2-bar-ui.js
from `soundmanager2.js` and `bar-ui.js`
'''
...
# NOTE: using the minified js for bar-ui.js, which may not work
# the jsdelivr minified bar-ui.js appeared to break the play/pause button
